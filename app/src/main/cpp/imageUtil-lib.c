...
JNIEXPORT void JNICALL Java_cn_my_gpuimage_common_GPUImageNativeLibrary_YUVtoRBGA(JNIEnv * env, jobject obj, jbyteArray yuv420sp, jint width, jint height, jintArray rgbOut)
{
    char msg[256] = {0};
    sprintf(msg, "%s ", "imageUtil-lib，YUVtoRBGA");
    logDebug(msg);
...
JNIEXPORT void JNICALL Java_cn_my_gpuimage_common_GPUImageNativeLibrary_YUVtoARBG(JNIEnv * env, jobject obj, jbyteArray yuv420sp, jint width, jint height, jintArray rgbOut)
{
    int             sz;
    int             i;
    int             j;
